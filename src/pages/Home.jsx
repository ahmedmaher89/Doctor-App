  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-7 col-md-6 col-sm-7">
              <img className="shape3" src="/imgs/shape3.png" alt="" />
              <h5 className="title-ext ">We Provide All Health Care Solutio</h5>
              <h2>Protect Your Health And Take Care To Of Your Health</h2>
              <button>
                <a href="#">Read More</a>
              </button>
              <span>
                <img src="/imgs/shape2.png" alt="" />
              </span>
              <span>
                <img className="shape1" src="/imgs/shape1.png" alt="" />
              </span>
            </div>
            <div className="col-lg-5 col-md-6 col-sm-5">
              <img src="/imgs/doctor.7c2bc96d.png" alt="" />
              <dir className="headerBox">
      ...
      <section className="work-area">
          ...
          <div className="row justify-content-center">
            <div className="col-lg-3 col-sm-6 mb-30">
              <div className="work-bx">
                ...
                <a className="btn btn-primary light" href="/react/booking">
            ...
            <div className="col-lg-3 col-sm-6 mb-30">
              <div className="work-bx">
                ...
                <a className="btn btn-primary light" href="/react/contact-us">
                  View More <i className="btn-icon-bx fas fa-chevron-right"></i>
                </a>
              </div>
            </div>
        ...
        <img className="wa-img1" src="/imgs/shapD.png" alt="" />
        <img className="wa-img2" src="/imgs/+.png" alt="" />
        <img className="wa-img3" src="/imgs/shape5.png" alt="" />
      </section>
              ...
              <div className="row align-items-center">
                    ...
                    <form action="#">
                      <div className="form-group">
                        <input
                          ...
                          placeholder="Selecty Department"
                        />
                      </div>
                      <div className="form-group">
                        <input
                      ...
                      <button type="submit" className="btn-secondaryW ">
                        Appointment Now
                      </button>
                    </form>
                  </div>
                ...
                <div className="col-xl-7 col-lg-6 col-md-12">
                  <div className="appointment-thumb">
                    <img src="/imgs/mobile.f82d7322.png" alt="" />
                    <div className="images-group">
                      <img
                        className="img1"
                        src="/imgs/women.eb5c49c5.png"
                        alt=""
                      />
                      <img className="img2" src="/imgs/work2.png" alt="" />
                      <img className="img3" src="/imgs/work3.png" alt="" />
                      <img className="img4" src="/imgs/work4.png" alt="" />
                      <img className="img5" src="/imgs/work5.png" alt="" />
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <img className="pt-img1" src="/imgs/shape4.png" alt="" />
            <img className="pt-img2" src="/imgs/shape1.png" alt="" />
            <img className="pt-img3" src="/imgs/shapA.png" alt="" />
            <img className="pt-img4" src="/imgs/shapD.png" alt="" />
          </div>
        </div>
      </section>
      ...
      <section className="section-area section-sp1 service-wraper">
        <div className="row align-items-center">
          <div className="col-xl-4 col-lg-7 mb-30">
            ...
            <a className="btn-secondary btn-lg shadow" href="#">
              All Services
            </a>
          </div>
          <div className="col-xl-8 mb-15 slide-serv">
            <Swiper
              slidesPerView={3}
              spaceBetween={30}
              pagination={{
                    ...
                    <div className="slider-item" tabIndex="-1">
                      <div className="feature-container feature-bx2 feature3">
                        ...
                        <div className="icon-content">
                          ...
                          <p>
                            Phasellus venenatis porta rhoncus. Integer et
                            viverra felis.
                          </p>
                          <a className="btn btn-primary light" href="#">
                            View More
        ...
        <img className="pt-img1" src="/imgs/serv1.png" alt="" />
        <img className="pt-img2" src="/imgs/shapD.png" alt="" />
        <img className="pt-img4" src="/imgs/serv2.png" alt="" />
