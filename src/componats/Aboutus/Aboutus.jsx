        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 rupy">
              ...
              <div className="row">
                <div className="col-lg-6 col-sm-6 rupy mb-sm-20">
              ...
              <Link className="btn btn-primary shadow" to="">
                Read More
              </Link>
            </div>
          </div>
        </div>
        <img className="pt-img1 " src="/imgs/shapA.png" alt="" />
        <img className="pt-img2" src="/imgs/shapB.png" alt="" />
        <img className="pt-img3" src="/imgs/shapC.png" alt="" />
        <img className="pt-img4" src="/imgs/shapD.png" alt="" />
        <img className="pt-img5" src="/imgs/shapC.png" alt="" />
      </section>
    </div>
  );
};
